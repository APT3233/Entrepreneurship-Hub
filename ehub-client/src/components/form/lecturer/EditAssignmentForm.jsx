              ...
              <li key={opt.value}>
                <button
                  ...
                  className={`w-full text-left px-4 py-2.5 text-sm transition-colors
                    ${opt.value === value ? "bg-accent-50 text-accent-700 font-medium" : "text-gray-700 hover:bg-gray-100"}`}
                >
                  {opt.label}
                </button>
              </li>
      ...
      <div className="bg-surface rounded-[32px] shadow-2xl w-full max-w-3xl overflow-hidden flex flex-col animate-in zoom-in-95 duration-300 max-h-[90vh]">
        ...
        <div className="px-8 py-6 space-y-6 overflow-y-auto custom-scrollbar pb-32">
          <div className="space-y-1.5">
            ...
            <input name="title" value={formData.title} onChange={handleChange} placeholder="Ví dụ: Báo cáo cuối kỳ" className="w-full px-4 py-2.5 rounded-xl bg-gray-50 border border-gray-100 focus:bg-surface focus:border-accent-400 focus:ring-4 focus:ring-accent-50 outline-none transition-all text-sm font-medium" />
          </div>

          <div className="space-y-1.5">
            <label className="text-[11px] font-bold text-gray-400 uppercase tracking-widest">Mô tả bài tập</label>
            <textarea name="description" value={formData.description} onChange={handleChange} rows={4} placeholder="Nhập hướng dẫn cụ thể cho sinh viên..." className="w-full px-4 py-3 rounded-xl bg-gray-50 border border-gray-100 focus:bg-surface focus:border-accent-400 focus:ring-4 focus:ring-accent-50 outline-none transition-all text-sm font-medium resize-none min-h-[100px]" />
          </div>
