...
export default function StudentNoGroupEmptyState({ className = "" }) {
  return (
    ...
    >
      ...
      <div className="rounded-[32px] bg-surface px-8 py-16 text-center shadow-sm sm:px-14">
        <div
          className="mx-auto mb-10 flex h-24 w-24 items-center justify-center rounded-full bg-gradient-to-br from-accent-50 to-violet-100 shadow-inner"
          aria-hidden
        >
          <div className="flex h-20 w-20 items-center justify-center rounded-full bg-surface/40 backdrop-blur-sm">
            <Users className="h-10 w-10 text-violet-600" strokeWidth={2.5} />
          </div>
        </div>
        
        <h2 className="text-[32px] font-semibold tracking-tight text-text-primary leading-tight">
          Bạn chưa tham gia nhóm nào
        </h2>
        
        <p className="mx-auto mt-6 max-w-lg text-[17px] leading-relaxed font-medium text-text-secondary">
      ...
      <div className="rounded-[32px] bg-surface p-6 shadow-sm sm:p-8">
        <div className="flex flex-col gap-5 sm:flex-row sm:items-start sm:gap-6">
          ...
          <div className="min-w-0 text-center sm:text-left">
            <h3 className="text-xl font-bold text-text-primary tracking-tight">Thông tin về nhóm học tập</h3>
            <p className="mt-2 text-base leading-relaxed font-medium text-text-secondary">
