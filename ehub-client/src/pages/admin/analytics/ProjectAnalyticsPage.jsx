  ...
  return (
    <div className="space-y-5">
      <AnalyticsFilterBar
        ...
        lookups={lookups}
        right={(
          <button type="button" onClick={() => exportRowsToCsv("project-analytics.csv", rows)} className="inline-flex items-center gap-2 rounded-xl bg-indigo-600 px-4 py-2.5 text-sm font-semibold text-white hover:bg-indigo-700">
