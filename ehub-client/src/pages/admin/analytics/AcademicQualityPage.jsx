  ...
  return (
    <div className="space-y-5">
      <AnalyticsFilterBar
        ...
        lookups={lookups}
        right={(
          <button type="button" onClick={() => exportRowsToCsv("academic-quality.csv", tableRows)} className="inline-flex items-center gap-2 rounded-xl bg-accent px-4 py-2.5 text-sm font-semibold text-white hover:bg-accent-hover">
