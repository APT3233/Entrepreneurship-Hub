...
export default function GroupDetailPage() {
  ...
  return (
    <div className="flex flex-col gap-6 w-full pb-10">
      ...
      {loading || !group ? (
        <div className="bg-surface rounded-card border border-border p-6 w-full animate-pulse">
      ...
      <div className="bg-surface border border-border rounded-card overflow-hidden flex flex-col">
        {/* Tab Header */}
        <div className="flex px-2 md:px-4 border-b border-border overflow-x-auto">
          {TABS.map((tab) => {
            const Icon = tab.icon;
            ...
            return (
              <button
                ...
                className={`flex items-center gap-2 px-4 md:px-6 py-3.5 md:py-4 text-sm font-medium transition-colors relative whitespace-nowrap shrink-0
                  ${active
                    ? "text-accent"
