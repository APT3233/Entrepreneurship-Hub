...
export const createMentorRouter = (container) => {
  ...
  router.post("/me/documents/initiate-upload", limiters.upload, can("mentor.document.manage"), validateRequest(initiateMentorSelfDocumentUploadSchema), mentorController.initiateMyDocumentUpload);
  router.post("/me/documents", limiters.upload, can("mentor.document.manage"), validateRequest(confirmMentorSelfDocumentUploadSchema), mentorController.confirmMyDocumentUpload);
