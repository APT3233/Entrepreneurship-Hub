...
import {
  ...
  createSessionSchema,
  groupIdParamSchema,
  listAssignmentRequestsSchema,
  listAssignmentsSchema,
  listSessionsSchema,
  updateAssignmentRequestStatusSchema,
...
export const createMentorWorkflowRouter = (container) => {
  ...
  const asMentor = [authenticate, roleGuard("mentor"), mentorStatusGuard(container)];
  ...
  router.get(
    ...
    mentorWorkflowController.getAssignment,
  );
  router.patch(
  ...
  router.get("/mentor/groups", ...asMentor, can("mentor.group.read"), mentorWorkflowController.listMyGroups);
  router.get("/mentor/groups/:groupId", ...asMentor, can("mentor.group.read"), validateRequest(groupIdParamSchema), mentorWorkflowController.getMyGroup);

  router.get("/mentor/sessions", ...asMentor, can("mentor.session.read"), validateRequest(listSessionsSchema), mentorWorkflowController.listMentorSessions);
  router.post("/mentor/sessions", ...asMentor, can("mentor.session.create"), validateRequest(createSessionSchema), mentorWorkflowController.createSession);
  router.get("/mentor/sessions/:id", ...asMentor, can("mentor.session.read"), validateRequest(sessionIdParamSchema), mentorWorkflowController.getSession);
  router.put("/mentor/sessions/:id", ...asMentor, can("mentor.session.update"), validateRequest(updateSessionSchema), mentorWorkflowController.updateSession);
  router.patch("/mentor/sessions/:id/status", ...asMentor, can("mentor.session.status"), validateRequest(updateSessionStatusSchema), mentorWorkflowController.updateSessionStatus);
  ...
  router.get("/lecturer/mentor-assignment-requests", authenticate, roleGuard("admin", "department_head", "lecturer"), can("mentor.assignment.request", "mentor.assignment.read"), validateRequest(listAssignmentRequestsSchema), mentorWorkflowController.listAssignmentRequests);
  router.patch("/lecturer/mentor-assignment-requests/:id", authenticate, roleGuard("admin", "department_head", "lecturer"), can("mentor.assignment.request"), validateRequest(updateAssignmentRequestStatusSchema), mentorWorkflowController.updateAssignmentRequestStatus);
  router.post("/lecturer/mentoring/sessions", authenticate, roleGuard("admin", "department_head", "lecturer"), can("mentor.session.create"), validateRequest(createSessionSchema), mentorWorkflowController.createSession);
  router.put("/lecturer/mentoring/sessions/:id", authenticate, roleGuard("admin", "department_head", "lecturer"), can("mentor.session.update"), validateRequest(updateSessionSchema), mentorWorkflowController.updateSession);
  router.patch("/lecturer/mentoring/sessions/:id/status", authenticate, roleGuard("admin", "department_head", "lecturer"), can("mentor.session.status"), validateRequest(updateSessionStatusSchema), mentorWorkflowController.updateSessionStatus);

  router.get("/groups/:groupId/mentors", authenticate, roleGuard("admin", "department_head", "lecturer", "student", "mentor"), can("mentor.assignment.read", "mentor.session.read"), validateRequest(groupIdParamSchema), mentorWorkflowController.listGroupMentors);
  ...
  router.patch("/mentoring-sessions/:id/attendance", authenticate, roleGuard("admin", "department_head", "lecturer", "mentor"), can("mentor.attendance.manage"), validateRequest(updateAttendanceSchema), mentorWorkflowController.updateAttendance);
